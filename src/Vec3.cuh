...
{
public:
    __host__ __device__ explicit Vec3(){}; // NOLINT
    ...
    __host__ __device__ inline float x() const noexcept { return m_data[0]; }
    __host__ __device__ inline float y() const noexcept { return m_data[1]; }
    __host__ __device__ inline float z() const noexcept { return m_data[2]; }
    __host__ __device__ inline float r() const noexcept { return m_data[0]; }
    __host__ __device__ inline float g() const noexcept { return m_data[1]; }
    __host__ __device__ inline float b() const noexcept { return m_data[2]; }
    ...
    __host__ __device__ inline float lengthSquared() const
    {
...
__host__ __device__ inline Vec3 operator*(float lhs, const Vec3& rhs)
{
    return { lhs * rhs.x(), lhs * rhs.y(), lhs * rhs.z() };
}

__host__ __device__ inline Vec3 operator/(const Vec3& lhs, float rhs)
{
...
__host__ __device__ inline Vec3& Vec3::operator*=(float scalar)
{
    m_data[0] *= scalar;
    m_data[1] *= scalar;
    m_data[2] *= scalar;
